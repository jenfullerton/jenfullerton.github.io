...
/*
		// float pupil = (sin(time/speed) + 1.0)/10.0 + 0.2;
		vec3 eCenter = rotate(point, 0.0, 0.0, 0.0);
		float ellipse = ellipseSDF(eCenter, vec3(0.2, 0.3, 0.4));
*/

		// float finalShape = blend(ellipse, sphereA, 0.5);
		return blend(sphereA, sphereB, 0.75);
	}
